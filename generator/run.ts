...
const GET_TYPES_URL = "https://development-api.integrationos.com/v1/public/schemas/types/typescript";
const GET_COMMON_MODELS_URL = "https://development-api.integrationos.com/v1/public/sdk/common-models?limit=500";

const generateSDK = async () => {
    try {
        console.log('🚀 Fetching types from IntegrationOS API...');
        ...
        console.log('🔍 Fetching resources from IntegrationOS API...');
